...
namespace LiquidWeb\WooBetterReviews\Tables\AuthorSetup;
...
function install_table() {
	...
	// Set our table name.
	$table_name = $wpdb->prefix . Core\TABLE_PREFIX .  'authorsetup';

	// Setup the SQL syntax.
	//
	// This stores the connection between a single author
	// and the characteristics a review can display.
	//
	$table_args = "
		CREATE TABLE {$table_name} (
			asetup_id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
			author_id BIGINT UNSIGNED NOT NULL,
			charstcs_id BIGINT UNSIGNED NOT NULL,
		PRIMARY KEY  (asetup_id),
