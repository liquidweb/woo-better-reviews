...
namespace LiquidWeb\WooBetterReviews\Tables\ProductSetup;
...
function install_table() {
	...
	//
	// This stores the connection between a single product
	// and the attributes it can display on a review.
	//
	$table_args = "
		CREATE TABLE {$table_name} (
			psetup_id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
			product_id BIGINT UNSIGNED NOT NULL,
			attribute_id BIGINT UNSIGNED NOT NULL,
		PRIMARY KEY  (psetup_id),
