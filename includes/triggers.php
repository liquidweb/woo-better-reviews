<?php
/**
 * Set up various triggers to run on other site actions.
 *
 * @package WooBetterReviews
 */

// Declare our namespace.
namespace LiquidWeb\WooBetterReviews\Triggers;
 ...
 * Start our engines.
 */
// add_action( 'wc_better_reviews_trigger_after_purchase_order_data', __NAMESPACE__ . '\after_purchase_order_data' );
// add_action( 'wc_better_reviews_trigger_after_purchase_order_data_no_items', __NAMESPACE__ . '\after_purchase_order_data_no_items' );
